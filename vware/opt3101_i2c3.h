 ...
 */
void OPT3101_3_Init(uint32_t frameCount);
 ...
 */
void OPT3101_3_CalibrateInternalCrosstalk(void);
 ...
 */
void OPT3101_3_StartMeasurement(void);
 ...
 */
void OPT3101_3_StartMeasurementChannel(uint32_t ch);
 ...
 */
void OPT3101_3_ReadMeasurement(void);
 ...
 */
bool OPT3101_3_MeasurementError(void);
 ...
 */
uint32_t OPT3101_3_GetDistanceMillimeters(void);
 ...
 */
uint32_t OPT3101_3_GetPhase(void);
 ...
 */
uint32_t OPT3101_3_GetAmplitude(void);
 ...
 */
uint32_t OPT3101_3_GetTxChannel(void);
 ...
 */
bool OPT3101_3_CheckDistanceSensor(void);
 ...
 */
uint32_t OPT3101_3_GetMeasurement(uint32_t distances[3], uint32_t amplitudes[3]);
 ...
 * @brief  get measurements from last measurement
 */
void OPT3101_3_ArmInterrupts(uint32_t *pTxChan, uint32_t distances[3], uint32_t amplitudes[3]);
